...
С помощью функций можно многократно вызывать ее блок операторов как единое целое в других
частях программы.
...
Если функция начинается с большой буквы, значит эта функция доступна из других пакетов.
Если функция с маленькой буквы, значит она доступна только внутри пакета.
