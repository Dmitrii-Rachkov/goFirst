...
func main() {
	...
	switchFallthrough()          // условная конструкция switch с Fallthrough
	switchConditionAfter(1)      // условная конструкция switch с условием в самих case
	for1()                       // простой цикл for
	for2()                       // цикл for без объявления переменной
	for3()                       // цикл for и счётчики в теле цикла
	for4()                       // цикл в котором использует только условие
