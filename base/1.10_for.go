...
/*
Можем выйти из всех циклов с помощью меток (любое название метки):
...
В нашем кейсе метка называется out, и при условии j == 3 в вложенном цикле, срабатывает
break с нашей меткой out. Таким образом мы выходим из всех циклов сразу.

Метку можно использовать также и с continue
*/
