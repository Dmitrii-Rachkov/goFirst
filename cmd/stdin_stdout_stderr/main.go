...
// stdout и stderr - это такие файлы в операционной системе и обычно они связаны с терминалом
// Если вы что-то выводили в консоль, в терминал, то обычно эти данные попадают в stdout или в stderr
func output() {
